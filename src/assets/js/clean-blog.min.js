...
!function (o) {
    ...
    if (992 < o(window).width()) {
        ...
        o(window).on("scroll", {previousTop: 0}, function () {
            ...
            i < this.previousTop ? 0 < i && o("#mainNav").hasClass("is-fixed") ? (o("#mainNav").addClass("is-visible"), o("#loginButton").addClass("btn-outline-dark")) : (o("#mainNav").removeClass("is-visible is-fixed"), o("#loginButton").removeClass("btn-outline-dark")) : i > this.previousTop && (o("#mainNav").removeClass("is-visible"), s < i && !o("#mainNav").hasClass("is-fixed") && o("#mainNav").addClass("is-fixed")), this.previousTop = i
        })
    }
}(jQuery);
